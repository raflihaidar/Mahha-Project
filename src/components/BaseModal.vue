...
<template>
  ...
  <transition @before-enter="onBeforeEnter" @enter="onEnter" @before-leave="beforeLeave" @leave="onLeave" :css="false">
    <article class="sm:w-[50vw] w-full top-0 left-0 h-full fixed overflow-y-scroll no-scrollbar z-[100]" v-if="isOpen">
