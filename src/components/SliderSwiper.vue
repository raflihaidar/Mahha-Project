...
<template>
  <swiper id="mySwiper" :loop="true" :modules="[Navigation]" @swiper="onSwiper" @slideChange="onSlideChange"
    ...
    <ButtonSlider :current-index="currentIndex" :data-length="images.length" :color-icon="colorIcon"
