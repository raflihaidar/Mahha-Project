...
<template>
  <Teleport to="body">
    <nav
      class="fixed top-0 text-light-default w-screen flex justify-between items-center bg-transparent p-4 lg:px-8 2xl:px-10 lg:py-4 z-50"
    >
      ...
      <section class="text-xs font-thin cursor-pointer block md:hidden" @click="isMenuOpen = true">
        <p>MENU</p>
      </section>
