<template>
  <footer class="bg-dark-default sm:px-10 px-5 py-5 flex flex-col sm:space-y-52 space-y-28">
    ...
    >
      ...
      <ul
        class="flex flex-col sm:flex-row irems-center text-center gap-y-5 gap-x-5 uppercase text-sm"
      >
        <li>Accomodation</li>
        <li>Experiences</li>
        <li>Dinning</li>
    ...
    <section class="w-full grid sm:grid-cols-4 gap-y-5 gap-x-10">
      <div>
        ...
        <address class="text-light-shade-1">
      ...
      <div>
        ...
        <section class="text-light-shade-1">
          <p>Tel: 0251​​ 123 45</p>
      ...
      <div>
        <section
          class="flex justify-between items-center text-light-default border-b-2 pb-3 mb-3 border-[#96742A]"
        >
          <h3>Time</h3>
          <p>GMT+7</p>
        </section>
    ...
    <section class="w-full flex justify-between">
      ...
      <section class="text-light-shade-1 text-sm">
