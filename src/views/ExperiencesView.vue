...
<template>
  ...
  <section
    ...
    <section class="w-[95%] sm:w-[40%] grid gap-y-5 place-items-start mx-auto max-sm:mt-10 sm:relative">
      ...
      <figure class="absolute sm:-top-96 top-20 left-5 sm:left-0 sm:right-10 w-40 sm:w-[384px] overflow-hidden"
        ...
        <img src="../assets/images/Experiences_Page/Experiences-01.jpg" data-scroll data-scroll-speed="-1" alt=""
          class="w-full h-full" />
      </figure>
    </section>
    <figure class="w-[70%] sm:w-[40%] self-end overflow-hidden" data-scroll data-scroll-repeat>
      <img src="../assets/images/Experiences_Page/Experiences-02.jpg" alt="" class="w-full h-full" data-scroll
        data-scroll-speed="-1" />
    </figure>
  </section>
    ...
    <section
      ...
      <article v-for="(item, index) in cardContent" :key="index" class="flex-shrink-0 w-64 snap-center sm:w-auto group">
        <figure class="overflow-hidden" data-scroll data-scroll-repeat>
          <img :src="getImageUrl(item.image)" alt="Judul Konten"
      ...
      <BaseModal :isOpen="showModal" @closeModal="showModal = false" :subTitle="modalData.subTitle"
        ...
        :contents="['Set out on a thrilling bike trek through the lush, scenic trails of Puncak. Wind your way through verdant forests, peaceful meadows, and breathtaking vistas, as you feel the cool mountain breeze guide you along the path. Whether you’re seeking a gentle ride or an adventurous challenge, our trails offer the perfect balance of tranquility and excitement.', 'Each turn of the trail reveals something new—hidden paths, local wildlife, and stunning viewpoints that will leave you in awe of nature’s beauty. This is more than just a bike ride; it’s an immersive journey through the heart of Puncak’s natural wonders.']">
      </BaseModal>
    </section>
  </section>
  ...
  <section
    ...
    <figure class="w-[70%] sm:w-[40%] overflow-hidden" data-scroll data-scroll-repeat>
      <img src="../assets/images/Experiences_Page/Experiences-07.jpg" alt="" class="w-full" data-scroll
        data-scroll-speed="-1" />
    </figure>
    <section class="w-[95%] sm:w-[40%] max-sm:pt-[200px] grid gap-y-5 place-items- sm:relative">
      ...
      <figure
        ...
        data-scroll data-scroll-repeat>
        <img src="../assets/images/Experiences_Page/Experiences-08.jpg" alt="" class="w-full" data-scroll
          data-scroll-speed="-1" />
      </figure>
    </section>
  </section>
