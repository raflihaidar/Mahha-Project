...
<template>
  ...
  <BaseBackground :img-src="Image1" :top-gradient="{
    fromColor: 'from-light-shade-2/20',
    toColor: 'to-light-shade-2/0',
  }" :bottom-gradient="{
  ...
  <section
    class="sm:px-10 mx-auto space-y-10 py-60 w-full h-full bg-gradient-to-b mix-blend-screen from-dark-default/100 from-50 via-dark-default/80 via-40 to-dark-default/10 to-10 flex flex-col sm:flex-row justify-between">
    <article class="sm:w-1/2 w-full flex justify-center">
      <div class="sm:w-1/2 w-[90%] mx-auto">
        ...
        <p class="w-full place-self-center text-light-shade-1 text-base font-thin text-justify mb-5">
    ...
    <section class="w-full flex justify-center items-end gap-x-5">
      <figure class="overflow-hidden sm:w-72 w-28 h-fit" data-scroll data-scroll-repeat>
        <img src="@/assets/images/Home_Page/Home-04.jpg" alt="" class="w-full h-full" data-scroll
          data-scroll-speed="-1" />
      </figure>
      <figure class="overflow-hidden sm:w-96 w-52 h-fit" data-scroll data-scroll-repeat>
        <img src="@/assets/images/Home_Page/Home-05.jpg" alt="" class="w-full h-full" data-scroll
          data-scroll-speed="-1" />
      </figure>
    </section>
  </section>
